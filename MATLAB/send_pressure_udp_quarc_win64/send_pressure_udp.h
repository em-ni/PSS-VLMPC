...
#ifndef RTW_HEADER_send_pressure_udp_h_
#define RTW_HEADER_send_pressure_udp_h_
#include <string.h>
#ifndef send_pressure_udp_COMMON_INCLUDES_
# define send_pressure_udp_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* send_pressure_udp_COMMON_INCLUDES_ */

#include "send_pressure_udp_types.h"
...
#define send_pressure_udp_rtModel      RT_MODEL_send_pressure_udp_T

/* Block signals (default storage) */
typedef struct {
  real_T VectorConcatenate[3];         /* '<Root>/Vector Concatenate' */
} B_send_pressure_udp_T;
...
typedef struct {
  ...
  real_T HILReadAnalog2_Buffer;        /* '<Root>/HIL Read Analog2' */
...
} DW_send_pressure_udp_T;

/* Backward compatible GRT Identifiers */
#define rtB                            send_pressure_udp_B
#define BlockIO                        B_send_pressure_udp_T
#define rtP                            send_pressure_udp_P
#define Parameters                     P_send_pressure_udp_T
#define rtDWork                        send_pressure_udp_DW
#define D_Work                         DW_send_pressure_udp_T

/* Parameters (default storage) */
struct P_send_pressure_udp_T_ {
  ...
  uint32_T HILReadAnalog3_channels;    /* Mask Parameter: HILReadAnalog3_channels
                                        ...
                                        */
  uint32_T HILReadAnalog2_channels;    /* Mask Parameter: HILReadAnalog2_channels
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Constant2_Value;              /* Expression: 0.5126
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T Gain2_Gain;                   /* Expression: 1/0.2326
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T Constant_Value;               /* Expression: 0.5126
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Gain7_Gain;                   /* Expression: 1/0.2326
                                        * Referenced by: '<Root>/Gain7'
                                        */
  real_T Constant1_Value;              /* Expression: 0.5126
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Gain1_Gain;                   /* Expression: 1/0.2326
...
struct tag_RTM_send_pressure_udp_T {
  const char_T *path;
...
extern P_send_pressure_udp_T send_pressure_udp_P;

/* Block signals (default storage) */
extern B_send_pressure_udp_T send_pressure_udp_B;

/* Block states (default storage) */
extern DW_send_pressure_udp_T send_pressure_udp_DW;

/* Model entry point functions */
extern void send_pressure_udp_initialize(void);
extern void send_pressure_udp_output(void);
extern void send_pressure_udp_update(void);
extern void send_pressure_udp_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern send_pressure_udp_rtModel *send_pressure_udp(void);
...
extern RT_MODEL_send_pressure_udp_T *const send_pressure_udp_M;
 ...
 *
 * '<Root>' : 'send_pressure_udp'
 */
#endif                                 /* RTW_HEADER_send_pressure_udp_h_ */
