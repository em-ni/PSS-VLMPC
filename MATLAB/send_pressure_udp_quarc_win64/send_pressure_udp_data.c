...
P_send_pressure_udp_T send_pressure_udp_P = {
  /* Mask Parameter: UDPSend_remotePort
   * Referenced by: '<Root>/UDP Send'
   */
  25000,

  /* Mask Parameter: HILReadAnalog3_channels
  ...
  /* Computed Parameter: HILReadAnalog3_Active
   * Referenced by: '<Root>/HIL Read Analog3'
   */
  1,

  /* Computed Parameter: HILReadAnalog2_Active
   * Referenced by: '<Root>/HIL Read Analog2'
   */
  1,
